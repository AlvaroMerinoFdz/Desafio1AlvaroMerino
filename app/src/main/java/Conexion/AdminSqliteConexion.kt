...
class AdminSQLiteConexion(
    ...
    override fun onCreate(db:SQLiteDatabase){
        ...
        db.execSQL("CREATE TABLE ${Constantes.TABLA_TAREAS}(${Constantes.CODIGO_TAREAS} integer,${Constantes.IDCRUZADO_TAREAS} integer, ${Constantes.DESCRIPCION_TAREAS} text,${Constantes.FOTO_TAREAS} TEXT,${Constantes.REALIZADO_TAREAS} BOOL)")
    }
